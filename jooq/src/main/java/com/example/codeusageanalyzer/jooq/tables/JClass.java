...
public class JClass extends TableImpl<JClassRecord> {
    ...
    private static final long serialVersionUID = -930522761;
     ...
     */
    public final TableField<JClassRecord, String> CLASS_ID = createField("CLASS_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.CLASS.CLASS_NAME</code>.
     */
    public final TableField<JClassRecord, String> CLASS_NAME = createField("CLASS_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.CLASS.MODULE_ID</code>.
     */
    public final TableField<JClassRecord, String> MODULE_ID = createField("MODULE_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.CLASS.SUPER_CLASS_NAME</code>.
     */
    public final TableField<JClassRecord, String> SUPER_CLASS_NAME = createField("SUPER_CLASS_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
