...
public class JRepository extends TableImpl<JRepositoryRecord> {
    ...
    private static final long serialVersionUID = -571927130;
     ...
     */
    public final TableField<JRepositoryRecord, String> REPOSITORY_ID = createField("REPOSITORY_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.REPOSITORY.URL</code>.
     */
    public final TableField<JRepositoryRecord, String> URL = createField("URL", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
