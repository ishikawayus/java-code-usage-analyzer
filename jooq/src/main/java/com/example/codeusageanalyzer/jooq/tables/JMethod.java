...
public class JMethod extends TableImpl<JMethodRecord> {
    ...
    private static final long serialVersionUID = 2093199930;
     ...
     */
    public final TableField<JMethodRecord, String> METHOD_ID = createField("METHOD_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.METHOD.CLASS_ID</code>.
     */
    public final TableField<JMethodRecord, String> CLASS_ID = createField("CLASS_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.METHOD.DESCRIPTOR</code>.
     */
    public final TableField<JMethodRecord, String> DESCRIPTOR = createField("DESCRIPTOR", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.METHOD.METHOD_NAME</code>.
     */
    public final TableField<JMethodRecord, String> METHOD_NAME = createField("METHOD_NAME", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
