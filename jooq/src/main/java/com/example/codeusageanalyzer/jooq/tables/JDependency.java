...
public class JDependency extends TableImpl<JDependencyRecord> {
    ...
    private static final long serialVersionUID = -1645813436;
     ...
     */
    public final TableField<JDependencyRecord, String> DEPENDENCY_ID = createField("DEPENDENCY_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.DEPENDENCY.ARTIFACT_ID</code>.
     */
    public final TableField<JDependencyRecord, String> ARTIFACT_ID = createField("ARTIFACT_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.DEPENDENCY.GROUP_ID</code>.
     */
    public final TableField<JDependencyRecord, String> GROUP_ID = createField("GROUP_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.DEPENDENCY.MODULE_ID</code>.
     */
    public final TableField<JDependencyRecord, String> MODULE_ID = createField("MODULE_ID", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");

    /**
     * The column <code>PUBLIC.DEPENDENCY.VERSION</code>.
     */
    public final TableField<JDependencyRecord, String> VERSION = createField("VERSION", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
