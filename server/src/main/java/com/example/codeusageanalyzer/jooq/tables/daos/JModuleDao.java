...
public class JModuleDao extends DAOImpl<JModuleRecord, JModulePojo, Long> {
     ...
     */
    @Override
    protected Long getId(JModulePojo object) {
     ...
     */
    public List<JModulePojo> fetchByJModuleId(Long... values) {
     ...
     */
    public JModulePojo fetchOneByJModuleId(Long value) {
     ...
     */
    public List<JModulePojo> fetchByJRepositoryId(Long... values) {
