...
public class JInterface extends TableImpl<JInterfaceRecord> {
     ...
     */
    public final TableField<JInterfaceRecord, Long> INTERFACE_ID = createField("INTERFACE_ID",
            org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.INTERFACE.CLASS_ID</code>.
     */
    public final TableField<JInterfaceRecord, Long> CLASS_ID = createField("CLASS_ID",
            org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.INTERFACE.INTERFACE_NAME</code>.
     */
    public final TableField<JInterfaceRecord, String> INTERFACE_NAME = createField("INTERFACE_NAME",
