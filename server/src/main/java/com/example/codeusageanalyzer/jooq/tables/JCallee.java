...
public class JCallee extends TableImpl<JCalleeRecord> {
     ...
     */
    public final TableField<JCalleeRecord, Long> CALLEE_ID = createField("CALLEE_ID",
            org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.CALLEE.DESCRIPTOR</code>.
     */
    public final TableField<JCalleeRecord, String> DESCRIPTOR = createField("DESCRIPTOR",
     ...
     */
    public final TableField<JCalleeRecord, String> METHOD_NAME = createField("METHOD_NAME",
            org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
